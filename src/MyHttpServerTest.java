...
public class MyHttpServerTest {
    ...
    public void identifyArguments(){
        String[] a ={"--port","8080","--responses","10","--directory","/tmp"};
    ...
    public void identifyArguments2(){
        String[] b ={"--directory","/tmp","--port","8080","--responses","10"};
    ...
    public void invalidPathInServerArguments(){
        ...
        Arguments arguments = new Arguments(8080,"foo",10); //unreasonable directory path
        MyHttpServer.serverInit(server, arguments);
    }
}
